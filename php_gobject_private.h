...
typedef struct _php_gobject_namespace_holder {
	php_gobject_gobj_to_php_t gobj_to_php;
	php_gobject_php_to_gobj_t php_to_gobj;
} php_gobject_namespace_holder;
